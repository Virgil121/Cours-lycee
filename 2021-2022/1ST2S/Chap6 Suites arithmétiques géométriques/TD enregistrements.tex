...
\newcommand{\contenua}{\setcounter{exercice}{0}
\begin{exercice}
...
\newcommand{\contenub}{\setcounter{exercice}{1}
\begin{exercice}
...
\newcommand{\contenuc}{\setcounter{exercice}{2}
\begin{exercice}
...
\newcommand{\contenud}{\setcounter{exercice}{3}
\begin{exercice}
...
\newcommand{\contenue}{\setcounter{exercice}{4}
\begin{exercice}
Deux salariés d'une entreprise, Paul et Pierre, ont perçu chacun, en fin d'année 2021, une prime suite aux bénéfices réalisés. Pour l'année 2021, Paul a reçu 120 euros et Pierre a reçu 100 euros.
...
On modélise les primes perçues, exprimées en euros, par Paul et Pierre à l'aide de deux suites $u$ et $v$. Pour tout entier naturel $n$, $u_n$ et $v_n$ représentent donc la prime perçue respectivement par Paul et Pierre l'année $2021+n$. On a donc $u_0=120$ et $v_0=100$.
