...
\end{enumerate}
\item Procéder de même avec la suite $(g_n)$ sur la colonne C. On utilisera la formule: \ \verb|=C2*1.2|. Pour avoir une meilleure lisibilité, on pourra sélectionner la colonne C, faire un clic droit puis "Formater des cellules", puis mettre le nombre de décimales à 0.
...
\item Réaliser un graphe représentant ces deux suites: Selectionner les colonnes $B$ et $C$, puis dans le menu en haut de la fenêtre, cliquer sur "Insertion", puis "Diagramme" et enfin "Terminer".
...
%\rem{Pour le covid c'était pas 1.2 mais entre 0.8 et 2.8 pour les pires moments !}
