...
\addplot[samples=11,domain=(0:10),only marks,stylepoint,fill=blue]{-0.5*x+3};
...
styleglobal,
hauteurproptick,
width=0.85*\echellepgfinv*\linewidth,
xmin=-0.5, xmax=10.5,
ymin=-1100, ymax=1100,
xtick distance=1,
ytick distance=200,
...
\addplot[samples=11,domain=(0:10),only marks,fill=blue]{1*2^x};
\addplot[samples=11,domain=(0:10),only marks,mark=square*,fill=red]{50*1.25^x};
\addplot[samples=11,domain=(0:10),only marks,mark=triangle*,fill=green]{-400*1.1^x};
\legend{$u_0=1,\ q=2$\\$v_0=50,\ q=1.25$\\$w_0=-400,\ q=1.1$\\} % \\ nécessaire pour que la virgule fonctionne
%\addplot[styleplot,color=red,domain=(1:2)]{1} \pointsextremites;	%test
%\node[stylepoint,fill=blue,inner sep=1.4pt] at (4.9,0.5) {};		%test
\end{axis}
\end{tikzpicture}
...
\addplot[samples=11,domain=(0:10),only marks,fill=blue]{4*0.5^x};
\addplot[samples=11,domain=(0:10),mark=square*,only marks,fill=red]{-5*0.9^x};
