...
\begin{exercice}
Une microentreprise fabrique des ventilateurs. On note $B(x)$ le résultat financier (bénéfice ou perte), exprimé en centaines d'euros, réalisé par l'entreprise pour la production de $x$ centaines de ventilateurs, lorsque $x \in [0;+\infty[$. On a $B(x)=-2x^2+90x-400$.
\begin{enumerate}
...
\compo[0.5]
{
\strut On s'intéresse à la trajectoire d'un ballon de
