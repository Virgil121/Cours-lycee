...
\addplot[styleplot]{x^2} node[pos=0.65,right] {$\mathscr C_f:\fbox{a>0}$};
\addplot[styleplot,color=DarkRed,domain=(-6:-2)]{3*(x+4)^2-4} node[pos=0.82,left] {$\mathscr C_g:\fbox{a>0}$};
\addplot[color=DarkBlue,styleplot]{2-0.25*(x-1)^2} node[pos=0.8,right] {$\mathscr C_h:\fbox{a<0}$};
\end{axis}
\end{tikzpicture}
\end{centrer}
\end{exs}
...
\addplot[styleplot]{0.7-0.5*(x-1.3)^2} node[pos=0.6,above right] {$\mathscr C_f$};
...
\section{Fonctions \texorpdfstring{$x \mapsto ax^2+c$}{x -> ax²+c}}
...
\addplot[styleplot]{x^2} node[pos=0.65,right] {$\mathscr C_f:\fbox{a>0}$};
\addplot[styleplot,color=DarkRed,domain=(-2:2)]{3*(x)^2-3} node[pos=0.54,right] {$\mathscr C_g:\fbox{a>0}$};
\addplot[color=DarkBlue,styleplot]{2-0.25*(x)^2} node[pos=0.7,right] {$\mathscr C_h:\fbox{a<0}$};
\end{axis}
\end{tikzpicture}
\end{centrer}
\end{exs}
...
\addplot[styleplot]{2*x^2+1} node[pos=0.53,right] {$\mathscr C_f$};
...
\section{Fonctions \texorpdfstring{$x \mapsto a(x-x_1)(x-x_2)$}{x -> a(x-x1)(x-x2)}}
...
\addplot[styleplot]{0.5*(x-1)*(x-3)} node[pos=0.65,below right] {$\mathscr C_f$};
...
\addplot[styleplot]{-2*(x-2)*(x+4)} node[pos=0.6,above right] {$\mathscr C_f$};
