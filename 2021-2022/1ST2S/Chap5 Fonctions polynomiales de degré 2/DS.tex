...
\item En utilisant le point $A(2;0)$, déterminer $a$, et en déduire l'équation de $\mathscr P$, sous forme développée puis factorisée.
\end{enumerate}
}
{
\begin{centrer}
...
\addplot[styleplot,domain=(-4:4)]{(-0.5*x^2+2} node[pos=0.6,above right]{$\mathscr P$};;
\end{axis}
\end{tikzpicture}
\end{centrer}
}
