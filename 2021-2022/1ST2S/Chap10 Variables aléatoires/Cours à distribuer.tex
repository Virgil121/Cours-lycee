...
{
\begin{itemize}
\item On dit qu'une variable aléatoire $X$ suit une loi de Bernoulli de paramètre $p$ lorsqu'elle associe 1 au succès et 0 à l'échec. Sa loi est représentée ci-contre.
\end{itemize}
}
{
\begin{center}
