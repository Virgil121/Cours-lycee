...
imgmaths/.style={
path picture={
      \node[opacity=0.5,anchor=west,rotate=-20] at (path picture bounding box.west) {
        \includegraphics[scale=0.2]{Fond}};}
}
}
...
path picture={
      \node[opacity=0.03,rotate=10] at ($(-3,-3)+(path picture bounding box.west)$) {
        \includegraphics[scale=0.6]{FondNegatif}};}
]
...
{
{\fontsize{25}{30}\selectfont\bf 1\textsuperscript{ère} ST2S}
};
