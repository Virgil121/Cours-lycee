...
\rem{ Schéma, placer les nombres $0,1,-2,3,0.5,\frac 1 {10}, \frac 1 3, \sqrt 2, \pi$, voir activité nuage}
...
\begin{defin}
Un encadrement décimal d'un nombre réel $x$ est une écriture $d_{1}\leq x \leq d_{2}$  avec $d_{1},d_{2}$ des nombres décimaux. La différence $d_{1}-d_{2}$ est l'amplitude de l'encadrement.
\end{defin}
