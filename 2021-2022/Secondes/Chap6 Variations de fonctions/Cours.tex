...
\addplot[styleplot,dashed,color=DarkGreen] plot {4} node[pos=0.8,above,color=DarkGreen!50!black] {maximum};
\addplot[styleplot,dashed,color=DarkGreen] plot {-1} node[pos=0.8,below,color=DarkGreen!50!black] {minimum};
\end{axis}
\end{tikzpicture}
\end{center}
}
