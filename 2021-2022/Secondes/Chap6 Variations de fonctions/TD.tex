...
\begin{exercice}
Soit $f$ une fonction définie sur $[-5;5]$, croissante sur $[-5;0]$ et décroissante sur $[0;5]$.
\begin{enumerate}
\item Comparer $f(-4)$ et $f(-2)$.
\item Comparer $f(0)$ et $f(3)$.
\item Comparer $f(-2)$ et $f(-5)$.
\item Peut-on comparer $f(-1)$ et $f(1)$?
\end{enumerate}
\end{exercice}
...
Dresser le tableau de variations des fonctions $f$, $g$ et $h$ définies sur le repère suivant:
\begin{center}
\begin{tikzpicture}
\begin{axis}[
styleglobal,
...
\item Donner le minimum de $f$ sur l'intervalle $[-3;1]$.
\end{enumerate}
\end{exercice}

\begin{exercice}
Dresser le tableau de variations des fonctions de l'exercice \ref{exoMax}.
\end{exercice}
