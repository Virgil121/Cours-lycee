...
\definecolor{MonRose}{RGB}{238,16,89}
\definecolor{MonEmeraude}{RGB}{0,169,157}
\definecolor{MonBleuRoyal}{RGB}{0,114,188}
...
{
{\fontsize{25}{30}\selectfont\bfseries 2\textsuperscript{nde} GT}
};
...
%\node[anchor=north west] at ($(titre.south west)+(1,0)$) {\fontsize{18}{21.6} \selectfont \textcolor{orange}{ \bfseries {M. DELAUNEY}}};
%\node[anchor=north east] at ($(titre.south east)+(-1,0)$) {\fontsize{18}{21.6} \selectfont \textcolor{orange}{ \bfseries {2021 - 2022}}};
\end{tikzpicture}

%\textcolor{RoyalBlue}{\rule{20pt}{20pt}} \textcolor{MonBleuRoyal}{\rule{20pt}{20pt}}
%\vspace{16cm}
%\begin{center}
