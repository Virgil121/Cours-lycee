...
\begin{defin}\setstretch{1.5}
Soient $O,I,J$ trois points du plan non alignés. On pose $\vv i = \vv{OI}$ et $\vv j = \vv{OJ}$. Un repère du plan est un triplet \makebox[4cm]{\dotfill} On dit alors que :
\begin{itemize}
\item $O$ est \dotfill\hspace{3cm}\strut
\item $(OI)$ est \dotfill\hspace{3cm}\strut
\item $(OJ)$ est \dotfill\hspace{3cm}\strut
\end{itemize}
\end{defin}

\begin{propr}
Tout point $M$ du plan est repéré par un unique couple de coordonnées $(x;y)$. $x$ est \makebox[4cm]{\dotfill} de $M$ et $y$ est \makebox[4cm]{\dotfill} de $M$.
\end{propr}
...
\begin{defin}
Soient $O,I,J$ trois points du plan non alignés. On pose $\vv i = \vv{OI}$ et $\vv j = \vv{OJ}$. Un repère du plan est un triplet \makebox[2cm]{\dotfill} On dit alors que :
\begin{itemize}
...
\item Les vecteurs unité $\vv i$ et $\vv j$ sont de même longueur: \makebox[2cm]{\dotfill}
\end{itemize}
}
{
\vspace{-2em}
