...
Soient $O,I,J$ trois points du plan non alignés. On pose $\vec i = \vec{OI}$ et $\vec j = \vec{OJ}$. Un repère du plan est un triplet \makebox[4cm]{\dotfill} On dit alors que :
\begin{itemize}
