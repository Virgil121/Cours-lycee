...
\begin{exercice}
Soient $A(6;5)$,$B(2;-3)$ et $C(-4;0)$. Quelle est la nature du triangle $ABC$?
\begin{centrer}
	\begin{resizetikz}{0.9\linewidth}
    \begin{tikzpicture}
...
\begin{exercice}
Prenons les points $A(1;-2)$ $B(2;5)$.
...
\begin{exercice}
Considérons les vecteurs $\vv{u}\binom{3}{9}$ et $\vv{v}\binom{6}{18}$. $\vv{u}$ et $\vv{v}$ sont-ils colinéaires?
\end{exercice}
...
\begin{exercice}
Dans un repère orthonormée on considère les points suivants:\\
$A(-1;4) \hfill B(\frac{1}{2};1) \hfill C(3;-4) \hfill D(-1;0) \hfill E(0;-2)$
\begin{enumerate}
    ...
    \item Démontrer que $(DE)$ et $(AB)$ sont parallèles.
\end{enumerate}
\end{exercice}

\begin{exercice}
Considérons les points: $A(2;3),\; B(5;7)$ et  $C(-7;-9)$.\\
