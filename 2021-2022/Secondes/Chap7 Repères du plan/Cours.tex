...
\draw[stylevecteur,color=black!30!red] (0,0) -- (1,0) node[pos=0.5,below] {$\vec i$};
\draw[stylevecteur,color=black!30!red] (0,0) -- (0,1) node[pos=0.5,left] {$\vec j$};
...
% Contenu
\node[stylepoint,fill=blue,label={below right:$M$}] (A) at (2,-1) {};
\end{axis}
\end{tikzpicture}
&
\begin{resizetikz}{0.9\linewidth} % Repère quelconque à la main
