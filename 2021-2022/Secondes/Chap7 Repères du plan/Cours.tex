...
$$\begin{aligned}[t] \left\Vert \vv{AM} \right\Vert &= \sqrt{(5-3)^2+(7-5)^2}\\
&=\sqrt{2^2+2^2}\\
&=\sqrt{4+4}\\
&=\sqrt 8 \simeq 2,83\end{aligned}$$
Comme $\left\Vert \vv{AM} \right\Vert \neq 3$, $M$ n'appartient pas au cercle $\mathcal C$.
\end{ex}
...
\begin{exs}
\begin{itemize}
\item On se donne $\vec u \dbinom 2 5$ et $\vec v \dbinom 4 {10}$. On remarque que $\vec v = 2 \vec u$. Alors $\vec u$ et $\vec v$ sont colinéaires.
