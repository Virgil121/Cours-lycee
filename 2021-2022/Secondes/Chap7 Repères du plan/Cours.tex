...
\draw[thin,draw=black!30,densely dashed] (liminf) rectangle (limsup);
...
\draw[step=1,thin,draw=black!30,densely dashed] ($5*(liminf)+(-5,-5)$)+(-0.01,-0.01) grid ($5*(limsup)+(5,5)$)+(0.01,0.01);
...
\draw[step=1,thin,draw=black!30,densely dashed]($5*(-2,-2)$)+(-5.01,-5.01) grid ($5*(8,5)$)+(5.01,5.01);
\tkzInit[xmin=5*(-2),xmax=5*10,ymin=5*(-2),ymax=5*5]
\tkzDrawX[label={},tickup=3pt,tickdn=3pt,thin]
