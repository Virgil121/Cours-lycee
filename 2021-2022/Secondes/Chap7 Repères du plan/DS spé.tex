...
\noindent Factoriser $A=81-36x^2$ \hfill Développer $B=(-2x+7)(3x+1)$ \hfill Résoudre $6x+4=29$
\vspace{5cm}
...
\item Déterminer les coordonnées du vecteur $-3 \vv{BC}$.
...
$\vv{SR} \dbinom 8 1$;
\hfill
$\begin{cases}PS=\sqrt{65}=5\sqrt{13} \\ QS=\sqrt{80}=4\sqrt 5 \end{cases}$
\hfill\strut
...
Soient $\vv u \tbinom 2 0$ et $ \vv v \tbinom {-5} 0$. Alors $\vv u$ et $\vv v$ sont colinéaires. & & \\ \hline
