...
\begin{tikzpicture}
	...
	\tkzDrawX[label={},xstep=1,left space=0.5]
	\tkzLabelX[frac=1,fill=none,below=3pt] % Option frac pour les graduations en fraction (aucun effet avec 1). Effet secondaire: centre bien les graduations...
    \draw[DarkBlue,very thick,font=\bfseries] (-2,0.3) -- (3,0.3) node[pos=0] {[} node[pos=1] {[};
    \draw[DarkRed,very thick,font=\bfseries] (-4,0.6) -- (1,0.6) node[pos=0] {[} node[pos=1] {]};
    \draw[DarkGreen,very thick,font=\bfseries] (-2,0.9) -- (1,0.9) node[pos=0] {[} node[pos=1] {]};
    \draw[RedOrange!90!black,very thick,font=\bfseries] (-4,1.2) -- (3,1.2) node[pos=0] {[} node[pos=1] {[};
