...
$$-2 = \frac {-2} 1 \in \Q,\qquad \frac 1 3 \in \Q,\qquad \frac 3 7 \in \Q,\qquad \sqrt 2 \not\in \Q$$
\end{defin}
...
\begin{center}
\begin{tikzpicture}
	\tkzInit[xmin=-3,xmax=4]
	\tkzSetUpAxis[ticka=3.5pt,tickb=3.5pt]	%Taille graduations
	\tkzDrawX[label={},xstep=1,left space=0.5]
	\tkzLabelX[frac=1,fill=none,below=3pt] % Option frac pour les graduations en fraction (aucun effet avec 1). Effet secondaire: centre bien les graduations...
	
    \draw[thin,black] (1.414,-0.07) -- ++(0,0.14) node[above] {$\sqrt 2$};
    \draw[thin,black] (3.142,-0.07) -- ++(0,0.14) node[above] {$\pi$};
    \draw[thin,black] (0.33,-0.07) -- ++(0,0.14) node[above] {$\frac 1 3$};
    \draw[thin,black] (-1.5,-0.07) -- ++(0,0.14) node[above] {$-1,5$};
\end{tikzpicture}
\end{center}
}
\end{propr}
...
\draw[fill=fond,fill opacity=0.1] (3.2,0) circle [x radius=60mm,y radius=28mm];
\draw[fill=fond,fill opacity=0.1] (2.4,0) circle [x radius=50mm,y radius=25mm];
\draw[fill=fond,fill opacity=0.1] (1.6,0) circle [x radius=40mm,y radius=22mm];
\draw[fill=fond,fill opacity=0.1] (0.8,0) circle [x radius=30mm,y radius=19mm];
\draw[fill=fond,fill opacity=0.1] (0,0) circle [x radius=20mm,y radius=16mm];
...
\begin{defin}
Soit $x\in \R$ tel que $d_{1}\leq x\leq d_{2}$ avec $d_{2}-d_{1}=10^{-n}$ où $n\in \N$.

L'arrondi à $10^{-n}$ de $x$ est celui de $d_{1}$ ou $d_{2}$ le plus proche de $x$.

Dans le cas où $d_{1}$ et $d_{2}$ sont à égale distance de $x$, l'arrondi à $10^{-n}$ de $x$ est $d_{2}$.
\end{defin}
...
\section{Intervalles de \texorpdfstring{$\R$}{R}}

\subsection{Généralités}

\begin{defin}
On veut écrire plus simplement \og Tous les nombres réels compris entre 2 et 5, 5 exclus \fg. Pour cela, il y a trois manières possibles:
\begin{itemize}
\item Par un schéma: \begin{tikzpicture}[baseline={([yshift=-.5ex]current bounding box.center)}]
	\tkzInit[xmin=0,xmax=6]
	\tkzSetUpAxis[ticka=3.5pt,tickb=3.5pt]	%Taille graduations
	\tkzDrawX[label={},xstep=1,left space=0.5]
	\tkzLabelX[frac=1,fill=none,below=3pt] % Option frac pour les graduations en fraction (aucun effet avec 1). Effet secondaire: centre bien les graduations...
	%
	\draw[DarkRed,very thick,font=\bfseries] (2,0) -- (5,0) node[pos=0] (deux) {[} node[pos=1] (cinq) {[};
	%
    \node[anchor=north] (cf) at (1,-1) {crochet fermé};
    \node[anchor=north] (co) at (6,-1) {crochet ouvert};
    \draw[->,>=latex,thick] (cf) to[bend left=10] (deux);
    \draw[->,>=latex,thick] (co) to[bend right=10] (cinq);
\end{tikzpicture}
\vspace{1mm}
...
\begin{center}
\begin{tabularx}{\linewidth}{|c|Y|Y<{\vspace{-2mm}}|} \hline
...
{$\left[ a;b \right]$} & {$a \leq x \leq b$} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries] (2,0) --(4,0) node[pos=0] {[} node[pos=1] {]};
    \node[below=8pt] at (2,0) {$a$};
    \node[below=6pt] at (4,0) {$b$};
\end{tikzpicture} \\ \hline 
{$\left] a;b \right]$} & {$a < x \leq b$} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries] (2,0) --(4,0) node[pos=0] {]} node[pos=1] {]};
    \node[below=8pt] at (2,0) {$a$};
    \node[below=6pt] at (4,0) {$b$};
\end{tikzpicture} \\ \hline 
{$\left[ a;b \right[$} & {$a \leq x < b$} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries] (2,0) --(4,0) node[pos=0] {[} node[pos=1] {[};
    \node[below=8pt] at (2,0) {$a$};
    \node[below=6pt] at (4,0) {$b$};
\end{tikzpicture} \\ \hline 
{$\left] a;b \right[$} & {$a < x < b$} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries] (2,0) --(4,0) node[pos=0] {]} node[pos=1] {[};
    \node[below=8pt] at (2,0) {$a$};
    \node[below=6pt] at (4,0) {$b$};
\end{tikzpicture} \\ \hline 
{$\left] - \infty;b \right]$} & {$x \leq b$} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries] (0,0) --(4,0) node[pos=1] {]};
    \node[below=6pt] at (4,0) {$b$};
\end{tikzpicture} \\ \hline 
{$\left] - \infty;b \right[$} & {$x < b$} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries] (0,0) --(4,0) node[pos=1] {[};
    \node[below=6pt] at (4,0) {$b$};
\end{tikzpicture} \\ \hline 
{$\left[ a;+ \infty \right[$} & {$a \leq x $} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries,->] (2,0) --(6,0) node[pos=0] {[};
    \node[below=8pt] at (2,0) {$a$};
\end{tikzpicture} \\ \hline 
{$\left] a; + \infty \right[$} & {$a < x$} & \begin{tikzpicture}
    \draw[thick,->] (0,0) --(6,0);
    \draw[ultra thick,DarkRed,font=\bfseries,->] (2,0) --(6,0) node[pos=0] {]};
    \node[below=8pt] at (2,0) {$a$};
\end{tikzpicture} \\ \hline
...
\begin{ex}
Pour {\color{DarkBlue}$I=[-2;3[$} et {\color{DarkRed}$J=[-4;1]$}, on a {\color{DarkGreen}$I \cap J = [-2;1]$} et {\color{RedOrange!90!black}$I \cup J = [-4;3[$}.
...
\begin{tikzpicture}[>=latex,yscale=1.5]
	...
	\tkzDrawX[label={},xstep=1,left space=0.5]
	\tkzLabelX[frac=1,fill=none,below=3pt] % Option frac pour les graduations en fraction (aucun effet avec 1). Effet secondaire: centre bien les graduations...
    \draw[DarkBlue,very thick,font=\bfseries] (-2,0.2) -- (3,0.2) node[pos=0] {[} node[pos=1] {[};
    \draw[DarkRed,very thick,font=\bfseries] (-4,0.4) -- (1,0.4) node[pos=0] {[} node[pos=1] {]};
    \draw[DarkGreen,very thick,font=\bfseries] (-2,0.6) -- (1,0.6) node[pos=0] {[} node[pos=1] {]};
    \draw[RedOrange!90!black,very thick,font=\bfseries] (-4,0.8) -- (3,0.8) node[pos=0] {[} node[pos=1] {[};
