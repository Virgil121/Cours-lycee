...
\end{itemize}
\item REPORTE : Croissance, décroissance, monotonie, tableaux de variations
\end{programme}
%\begin{FlushLeft}
...
\begin{center}
\vspace{-2mm}
\begin{tabularx}{1\linewidth}{|X|X|X|} \hline
\Centering{
\begin{tikzpicture}[scale=\echellepgf]
\begin{axis}[
styleglobal,
...
\draw[cadre] (4*\Lrg,-0.5*\HtX) -- (4*\Lrg,-1.5*\HtX) node[pos=0.5,line width=0.6pt,draw=black,circle,minimum size=7pt,fill=bg,inner sep=2pt,yscale=1.25] {};
