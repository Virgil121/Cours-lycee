...
Dresser le tableau de signes des fonctions $f$, $g$ et $h$ définies sur le repère suivant:
\begin{centrer}
\begin{tikzpicture}[scale=\echellepgf]
\begin{axis}[
styleglobal,
...
\begin{exercice}
Dresser le tableau de signes des fonctions de l'exercice 38.
\end{exercice}
...
\end{minipage}
\end{centrer}
\noindent Dans un repère, tracer une courbe susceptible de représenter la fonction $f$.
\end{exercice}
...
\begin{exercice}[*]
On se donne une fonction $f$ définie sur $[-5;4]$. On a dressé son tableau de signes ci-dessous:
\begin{centrer}
\begin{tikzpicture}[scale=0.875]
