...
\begin{enumerate}
\item Soit $f$ une fonction définie sur $[4;13]$, croissante sur $[4;6]$, décroissante sur $[6;10]$ puis croissante sur $[10;13]$. Comparer $f(7)$ et $f(8,5)$.
...
\addplot[styleplot,tension=0.3] plot coordinates{(-3,2.5) (-1,1.5) (1,-1.5) (3,1) (5,0.5) (6,2) (7,3)} node[pos=0.9,below right] {$\mathscr C_g$} \pointsextremites;
\end{axis}
\end{tikzpicture}
\end{center}
}
