...
$$d_1:y=2x+0.5 \ \text{ et } \ d_2:y=-\frac 4 3 x+3$$
\end{enumerate}
\begin{centrer}
...
\begin{exercice}
Soit $f$ une fonction affine telle que $f(1)=6$ et $f(3)=12$. Déterminer l'expression de $f$.
...
Dresser le tableau de signes de la fonction $f:x \mapsto 5(x-5)(5x+10)$:\strut
...
\begin{enumerate}
\item Soit $f$ une fonction définie sur $[4;13]$, croissante sur $[4;6]$, décroissante sur $[6;10]$ puis croissante sur $[10;13]$. Comparer $f(7)$ et $f(9,75)$.
...
\addplot[styleplot,tension=0.3] plot coordinates{(-3,-1.5) (-1,1.5) (1,-2) (3,1) (5,0.5) (6,2) (7,3)} node[pos=0.9,below right] {$\mathscr C_g$} \pointsextremites;
\end{axis}
\end{tikzpicture}
\end{center}
}

\item Quel est le maximum de $g$ sur l'intervalle $[-3;7]$? Sur l'intervalle $[0;5]$?
