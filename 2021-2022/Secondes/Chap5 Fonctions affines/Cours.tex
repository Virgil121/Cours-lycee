...
\section{Recherche algébrique de \texorpdfstring{$a$}{a} et \texorpdfstring{$b$}{b}} % Erreur avec signets pdf hyperref, il faut faire une version LaTeX(gauche) et une version sans maths
