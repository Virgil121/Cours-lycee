...
Toutes ces flèches correspondent au même déplacement: On dit qu'elles représentent un même vecteur $\vv u$, et on note $\vv u = \vv {AA'} = \vv {BB'} = \ldots = \vv {EE'}$.

On dit que $\vv {AA'}, \ldots, \vv {EE'}$ sont des représentants du vecteur $\vv u$.
