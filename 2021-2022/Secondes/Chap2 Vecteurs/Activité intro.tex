...
Toutes ces flèches correspondent au même déplacement: On dit qu'elles représentent un même vecteur $\vec u$, et on note $\vec u = \vv {AA'} = \vv {BB'} = \ldots = \vv {EE'}$.

On dit que $\vv {AA'}, \ldots, \vv {EE'}$ sont des représentants du vecteur $\vec u$.

$A$ est l'origine du vecteur $\vv {AA'}$, et $A'$ est son extrémité.

On dit alors que $B'C'D'E'$ est \textbf{l'image} de $BCDE$ par la \textbf{translation} de vecteur $\vv {AA'}$.

\item Dans chacun des cas, tracer l'image du polygone par la translation de vecteur $\vv {AA'}$.
