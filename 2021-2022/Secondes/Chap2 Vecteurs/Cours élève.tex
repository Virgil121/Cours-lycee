...
\draw[ultra thick,->] (A) -- (B) node[pos=0.5,left] {\large $\vv u$};
\draw[ultra thick,->] (9,6) -- (13,2) node[pos=0.5,above right] {\large $\vv v$};
\node[color=black,circle,minimum size=1pt,fill,inner sep=2pt,fill opacity=1,label={-45:\textbf{\large C}}] (C) at (7,3) {};
\draw[ultra thick,->] (B) -- (C) node[pos=0.5,above right] {\large $\vv v$};
\draw[ultra thick,->,color=red] (A) -- (C) node[pos=0.5,below] {\large $\vv u + \vv v$};
...
\textbf{Attention :} En général, la longueur de $\vv u + \vv v$ n'est pas égale à la somme de celle de $\vv u$ et de $\vv v$: $\Vert \vv u + \vv v \Vert \neq \Vert \vv u \Vert + \Vert \vv v \Vert$
...
\draw[ultra thick,->] (A) -- (B) node[pos=0.5,above] {\large $\vv u$};
\draw[ultra thick,->] (A) -- (C) node[pos=0.5,above left] {\large $\vv v$};
\draw[color=red,ultra thick,->] (A) -- (D) node[pos=0.5,above right] {\large $\vv u + \vv v$};
...
\draw[ultra thick,->] (0,0) -- (4,0) node[pos=0,left] {\large $\vv u$};
\draw[ultra thick,->] (0,-2) -- (8,-2) node[pos=0,left] {\large $2 \vv u$};
\draw[ultra thick,<-] (0,-4) -- (4,-4) node[pos=0,left] {\large $-\vv u$};
\draw[ultra thick,->] (0,-6) -- (6,-6) node[pos=0,left] {\large $\frac 3 2 \vv u$};
\draw[ultra thick,<-] (0,-8) -- (12,-8) node[pos=0,left] {\large $-3\vv u$};
...
\begin{center}
\begin{tikzpicture}
\draw[line width=4pt,->] (0,0) -- (8,1) node[pos=0.75,above] {\large $\vv u$} node[pos=0,color=black,circle,minimum size=1pt,fill,inner sep=2pt,label={180:\textbf{\large A}}] {} node[pos=1,color=black,circle,minimum size=1pt,fill,inner sep=2pt,label={0:\textbf{\large B}}] {};
\draw[line width=2pt, color=red, ->] (0,0) -- (4,0.5) node[pos=0.5,below] {\large { $0.5\vv u$} } node[pos=1,color=red,circle,minimum size=1pt,fill,inner sep=2pt,label={90:\textbf{\large I}}] {};
\end{tikzpicture}
\end{center}
