...
\draw[ultra thick,color=black,->] (15,7) -- (12,4) node[pos=0.4,below right] {\large $\vv u$};
...
\begin{enumerate}
\item Placer $N$, l'image de $M$ par la translation de vecteur $\vv {AB}$.
\item Tracer un représentant du vecteur $\vv u$ ayant pour origine le point $B$.
\end{enumerate}
\end{exercice}
}
...
\draw[ultra thick,color=black,->] (5,2) -- (1,1) node[pos=0.7,below right] {\large $\vv u$};
...
\begin{enumerate}
\item Placer $N$, l'image de $M$ par la translation de vecteur $\vv {AB}$.
\item Tracer un représentant du vecteur $\vv u$ ayant pour origine le point $M$.
\end{enumerate}
\end{exercice}
}
