...
Effectuer la translation de vecteur $\vecc {AB}$ suivie de la translation de vecteur $\vecc {BC}$ revient à effectuer la translation de vecteur $\vecc {AC}$.

\end{enumerate}

On peut alors définir la somme de deux vecteurs $\vec u$ et $\vec v$: $A$ étant un point quelconque, on place le point $B$ tel que $\vecc {AB} = \vec u$ et $C$ tel que $\vecc {BC} = \vec v$. Alors $\vec u + \vec v$ est le vecteur $\vecc {AC}$.

On appelle cela la \textbf{relation de Chasles}:
$$\huge{\vecc {A \textbf B} + \vecc {\textbf BC} = \vecc {AC}}$$
