...
On peut alors définir la somme de deux vecteurs $\vec u$ et $\vec v$: $A$ étant un point quelconque, on place le point $B$ tel que $\vv {AB} = \vec u$ et $C$ tel que $\vv {BC} = \vec v$. Alors $\vec u + \vec v$ est le vecteur $\vv {AC}$.
